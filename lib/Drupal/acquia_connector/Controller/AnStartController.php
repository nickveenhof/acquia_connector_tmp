...
/**
 * @file
 * Contains \Drupal\acquia_connector\Form\AnStartController.
 */
...
/**
 * Class AnStartController.
 */
class AnStartController extends ControllerBase {

  /**
   * @todo.
   */
  public function info() {
    drupal_set_title($this->t('Get an Acquia Cloud Free subscription'));
